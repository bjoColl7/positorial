export default function StatsBar() {
  const stats = [
    ...
    { value: "60+", label: "Expert Articles", icon: "articles" },
    { value: "3", label: "Core Topics", icon: "topics" },
  ...
  return (
    <section className="section-padding -mt-8 relative z-10">
      <div className="bg-white rounded-2xl shadow-lg border border-cream-200 p-6 md:p-8">
